...
options:
  ...
  --task TASK, -t TASK  Jira issue key or URL (e.g., WEB3-3 or
                        https://holst.atlassian.net/browse/WEB3-3)
...
```env
JIRA_URL=https://holst.atlassian.net/
JIRA_EMAIL=your-email@example.com
JIRA_API_TOKEN=your-jira-token

CONFLUENCE_URL=https://holst.atlassian.net
...
- Full URL: `https://holst.atlassian.net/browse/WEB3-3`
