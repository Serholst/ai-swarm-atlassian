...
Usage:
    ...
    python3 execute.py --task https://holst.atlassian.net/browse/WEB3-3
"""
...
def parse_jira_key(task_input: str) -> str:
    ...
    Examples:
        - WEB3-3 → WEB3-3
        - https://holst.atlassian.net/browse/WEB3-3 → WEB3-3
        - holst.atlassian.net/browse/WEB3-3 → WEB3-3
    """
...
Examples:
  ...
  python3 execute.py -t WEB3-3
    ...
    parser.add_argument(
        "--task", "-t",
        required=True,
        help="Jira issue key or URL (e.g., WEB3-3 or https://holst.atlassian.net/browse/WEB3-3)"
    )
